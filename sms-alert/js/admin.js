...
function resetSaStyle(event) {
	...
	jQuery.ajax({
			type: "POST",
			url: 'admin.php?postname='+event.data.post_name+'&action=reset_style&nonce=' + smsalert.nonce,                                
			success: function (data) {
